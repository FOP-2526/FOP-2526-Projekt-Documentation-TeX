...
\duedate{20.03.2026 bis 23:50 Uhr}
\subtitle{Prof. Karsten Weihe}
\dozent{Prof. Karsten Weihe} % chktex 12
\fachbereich{Informatik}
\semester{Wintersemester 25/26} % z.B. SoSe 2022 oder WiSe 2022/2023
...
\begin{document}%
    ...
    \hue{FOP \getSheetnumber{}}{Tobago}{100}
    \nextTaskGroup{P}
    ...
    Dies ist die \LaTeX-Vorlage für das FOP-Projekt. Alle notwendigen Einstellungen können sie im Bereich Dokumenteneinstellungen ab Z. 135 anpassen:
